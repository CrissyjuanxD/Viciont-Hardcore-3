...
//ESTE MOB NO SE VA A USAR - MOB DE MOMENTO DESCARTADO

public class CorruptedMagmaCube_Descartado implements Listener {
    private final JavaPlugin plugin;
    private final NamespacedKey corruptedMagmaKey;
    private boolean eventsRegistered = false;

    public CorruptedMagmaCube_Descartado(JavaPlugin plugin) {
        this.plugin = plugin;
