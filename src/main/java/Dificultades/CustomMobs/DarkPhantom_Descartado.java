...
//ESTE MOB NO SE VA A USAR - MOB DESCARTADO

public class DarkPhantom_Descartado extends DarkMobSB implements Listener {
    private boolean eventsRegistered = false;

    public DarkPhantom_Descartado(JavaPlugin plugin) {
