...
public class HelmetNetheriteEssence {
    private final JavaPlugin plugin;

    public HelmetNetheriteEssence(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public ItemStack createHelmetNetheriteEssence() {
        ItemStack essence = new ItemStack(Material.ECHO_SHARD);
        ItemMeta meta = essence.getItemMeta();

        if (meta != null) {
            // Set display name
            meta.setDisplayName(ChatColor.of("#cc3300") + "" + ChatColor.BOLD + "Helmet Netherite Essence");
